...
export default class BeatPlannerLWC extends LightningElement {
    ...
    isProductScreen = false; isTaskScreen = false;
    isExecuteScreen = false; isPaymentScreen = false; isVisitHeader = false; isPhone = false; isDesktop = false; isCometitionScreen = false;
    currentLogId;
    @api dailylogData;
    visitData;
    pickListData;
    ...
    handleGetLatLon(locationProgress) {
        ...
        const timeoutTimer = setTimeout(() => {
            if (!isResolved) {
                ...
                this.genericDispatchEvent('Error', 'Please enable location permission to start your day', 'error');
            ...
            onClickVisitPopup(event){
                ...
                if (msg.message == 'Save') {
                    ...
                    if (this.Outlet) {
                        ...
                        // this.template.querySelector('c-outlet-screen2').handleUpdateChange();
                    }
                }
            }
            completeVisit(){
                setTimeout(() => {
                    const childComp = this.template.querySelector('c-execute-screen');
                    if (childComp) {
